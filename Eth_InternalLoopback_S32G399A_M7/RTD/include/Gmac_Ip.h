...
#define GMAC_IP_SW_PATCH_VERSION               2
 ...
 * @retval GMAC_STATUS_SUCCESS The operation completed successfully.
 * @retval GMAC_STATUS_ERROR The GMAC Mdio wasn't enabled beforehand.
 * @retval GMAC_STATUS_TIMEOUT The specified timeout expired before completing the operation.
 */
 ...
 * @note For the GMAC that have the ERR050109 the support for DisVlanTypeMatch, EnSvlanMatch and En12bitMatch will not be available
 */
