...
#define GMAC_IP_TYPES_AR_RELEASE_MINOR_VERSION       4
...
#define GMAC_IP_TYPES_SW_PATCH_VERSION               2
...
typedef struct sGmac_Ip_StateType
{
    ...
    uint16 RxRingCount;
    uint16 TxRingCount;
    boolean EnableMDIO;                                                     /*!< Variable which indicates if Gmap_Ip_EnableMDIO API was called. */
} Gmac_Ip_StateType;
/** @endcond */
