...
#define GMAC_IP_DEVICE_REGISTERS_SW_PATCH_VERSION             2
...
/* @internal @brief Macro for different between header files */
    #define MAC_VLAN_TAG_DATA       MAC_VLAN_TAG_DATA.MAC_VLAN_TAG_DATA
    #define MAC_VLAN_TAG_CTRL       MAC_VLAN_TAG_CTRL
    #define MAC_VLAN_INCL           MAC_VLAN_INCL.MAC_VLAN_INCL
