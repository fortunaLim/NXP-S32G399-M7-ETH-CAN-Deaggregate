...
#define GMAC_IP_CFG_SW_PATCH_VERSION_C              2
...
#endif
#ifdef GMAC_0_RXRING_3_DESCR
    /*! @brief Reception buffer descriptors for Rx Ring 3 */
    VAR_ALIGN(Gmac_Ip_BufferDescriptorType GMAC_0_RxRing_3_DescBuffer[GMAC_0_MAX_RXBUFF_SUPPORTED], FEATURE_GMAC_BUFFDESCR_ALIGNMENT_BYTES)
#endif
#ifdef GMAC_0_RXRING_3_DATA
    /*! @brief Reception data buffers for Rx Ring 3 */
    VAR_ALIGN(uint8 GMAC_0_RxRing_3_DataBuffer[GMAC_0_MAX_RXBUFF_SUPPORTED * GMAC_0_MAX_RXBUFFLEN_SUPPORTED], FEATURE_GMAC_BUFF_ALIGNMENT_BYTES)
#endif
#ifdef GMAC_0_RXRING_4_DESCR
    /*! @brief Reception buffer descriptors for Rx Ring 4 */
    VAR_ALIGN(Gmac_Ip_BufferDescriptorType GMAC_0_RxRing_4_DescBuffer[GMAC_0_MAX_RXBUFF_SUPPORTED], FEATURE_GMAC_BUFFDESCR_ALIGNMENT_BYTES)
#endif
#ifdef GMAC_0_RXRING_4_DATA
    /*! @brief Reception data buffers for Rx Ring 4 */
    VAR_ALIGN(uint8 GMAC_0_RxRing_4_DataBuffer[GMAC_0_MAX_RXBUFF_SUPPORTED * GMAC_0_MAX_RXBUFFLEN_SUPPORTED], FEATURE_GMAC_BUFF_ALIGNMENT_BYTES)
#endif
...
#endif
#ifdef GMAC_0_TXRING_3_DESCR
    /*! @brief Transmission buffer descriptors for Tx Ring 3 */
    VAR_ALIGN(Gmac_Ip_BufferDescriptorType GMAC_0_TxRing_3_DescBuffer[GMAC_0_MAX_TXBUFF_SUPPORTED], FEATURE_GMAC_BUFFDESCR_ALIGNMENT_BYTES)
#endif
#ifdef GMAC_0_TXRING_3_DATA
    /*! @brief Transmission data buffers for Tx Ring 3 */
    VAR_ALIGN(uint8 GMAC_0_TxRing_3_DataBuffer[GMAC_0_MAX_TXBUFF_SUPPORTED * GMAC_0_MAX_TXBUFFLEN_SUPPORTED], FEATURE_GMAC_BUFF_ALIGNMENT_BYTES)
#endif
#ifdef GMAC_0_TXRING_4_DESCR
    /*! @brief Transmission buffer descriptors for Tx Ring 4 */
    VAR_ALIGN(Gmac_Ip_BufferDescriptorType GMAC_0_TxRing_4_DescBuffer[GMAC_0_MAX_TXBUFF_SUPPORTED], FEATURE_GMAC_BUFFDESCR_ALIGNMENT_BYTES)
#endif
#ifdef GMAC_0_TXRING_4_DATA
    /*! @brief Transmission data buffers for Tx Ring 4 */
    VAR_ALIGN(uint8 GMAC_0_TxRing_4_DataBuffer[GMAC_0_MAX_TXBUFF_SUPPORTED * GMAC_0_MAX_TXBUFFLEN_SUPPORTED], FEATURE_GMAC_BUFF_ALIGNMENT_BYTES)
#endif
